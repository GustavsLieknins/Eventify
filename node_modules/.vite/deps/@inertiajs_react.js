...
function baseInRange(number, start3, end) {
  return number >= nativeMin5(start3, end) && number < nativeMax8(start3, end);
}
...
function baseRange(start3, end, step, fromRight) {
  var index = -1, length = nativeMax12(nativeCeil4((end - start3) / (step || 1)), 0), result2 = Array(length);
  while (length--) {
...
function spread(func, start3) {
  ...
  start3 = start3 == null ? 0 : nativeMax13(toInteger_default(start3), 0);
  return baseRest_default(function(args) {
  ...
  while (++index < length) {
    ...
    switch (data.type) {
      ...
      case "dropRight":
        ...
        break;
      case "take":
        end = nativeMin12(end, start3 + size2);
        break;
      case "takeRight":
        start3 = nativeMax15(start3, end - size2);
        break;
    }
  }
